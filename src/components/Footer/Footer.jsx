...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="w-full bg-gradient-to-b from-white to-[#F1F8E9]/45 border-t border-[#1B5E20]/5 font-sans"
    >
      {/* 1. Upper Section: Contact Split Grid */}
      <div className="max-w-7xl mx-auto pt-8 sm:pt-12 md:pt-16 pb-8 sm:pb-12 px-4 sm:px-6">
          ...
          <div className="lg:col-span-5 flex flex-col space-y-8 text-left">
            <div>
              ...
              <p className="text-gray-500 text-sm sm:text-base leading-relaxed mt-4">
                Sustainability isn't a destination; it's a collective journey.
                Whether you want to volunteer for campus cleanups, partner with
                us on green research, or simply ask a question, we'd love to
                hear from you.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 p-4 bg-white rounded-2xl border border-gray-100/80 shadow-xs hover:shadow-md transition-shadow duration-300">
                ...
                <div>
                  <h4 className="text-[#064e3b] text-sm font-bold">
                    Office Location
                  </h4>
                  <p className="text-gray-500 text-xs mt-1 leading-relaxed">
                    Student Center Building, 3rd Floor, Batangas State
                    University Alangilan Campus, Alangilan, Batangas City
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div>
                  <h4 className="text-[#064e3b] text-sm font-bold group-hover:text-[#1B5E20] transition-colors">
                    Email Address
                  </h4>
            ...
            <div className="pt-6 border-t border-gray-200/50">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-white border border-gray-100 rounded-2xl p-3 text-center shadow-xs">
                  <span className="block text-2xl font-bold text-[#1b5e20]">
                    17
                  </span>
      ...
      <div className="max-w-7xl mx-auto pt-6 pb-20 md:pb-8 px-4 sm:px-6">
